    ...
    <div class="admin-wrapper">
        ...
        <div class="card">
            <div class="card-header" style="flex-wrap: wrap; gap: 15px;">
                ...
                <form action="manage_blogs.php" method="GET" style="display: flex; gap: 10px; flex: 1; max-width: 400px; margin-left: auto;">
                    ...
                    <?php if(!empty($search)): ?>
                        <a href="manage_blogs.php" class="btn" style="background: #e2e8f0; color: #1e293b;">Clear</a>
                    <?php endif; ?>
                </form>
